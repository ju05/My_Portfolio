...
function setTheme(mode){
    ...
    if(mode == 'harry'){
        ...
        document.getElementById('muggle-greeting').innerHTML = '<img src="assets/images/hello-hp.png" style=" width: 80%; justify-content: center;" alt="hello there,  I am Juliana Schmidt in Harry Potters font">',
